...
import pytest
from app.models.models import Base, Seccion, Laboratorio
...
from app.core.auth_middleware import get_current_active_user, require_product_read, require_product_write
...
def test_update_seccion():
    ...
    response = client.put(f"/api/v1/secciones/{seccion_id}", json={
