...
def main():
    ...
    result = test_endpoint(
        ...
        f"{API_URL}/productos/search?q=test&page=1&size=10",
        headers=headers
    )
    print()
    ...
    result = test_endpoint(
        "Top Productos",
        f"{API_URL}/productos/top?limit=5&criterio=stock",
        headers=headers
    )
    print()
    ...
    result = test_endpoint(
        ...
        f"{API_URL}/productos/stats/por-laboratorio",
        headers=headers
    )
    print()
    ...
    result = test_endpoint(
        "Stats por Sección",
        f"{API_URL}/productos/stats/por-seccion",
        headers=headers
    )
    print()
    ...
    result = test_endpoint(
        "Cache Stats",
        f"{API_URL}/productos/cache/stats",
        headers=headers
    )
    if result and 'data' in result:
